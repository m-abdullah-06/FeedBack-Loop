...
export default function ReviewPage() {
  ...
  return (
    <div className="p-8 max-w-3xl">
      <div className="mb-10">
        <h1 className="font-display font-bold text-3xl mb-2">New Review</h1>
        <p className="text-text-muted">Submit a URL or code snippet for instant AI feedback.</p>
      </div>
        ...
        {type === "url" ? (
          <div>
            ...
            <p className="text-text-muted text-xs mt-2">
              We'll analyze the URL for UX patterns, performance hints, SEO signals, and accessibility issues.
            </p>
          </div>
        ) : (
          <>
            <div>
              ...
              <select
                ...
                className="bg-bg border border-border rounded-xl px-4 py-3 text-text-primary focus:outline-none focus:border-accent/50 transition-colors text-sm"
              >
                {LANGUAGES.map((l) => (
